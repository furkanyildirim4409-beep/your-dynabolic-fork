...
const ParametricBodySVG = ({ measurements }: ParametricBodySVGProps) => {
  ...
  return (
    <svg viewBox="0 0 120 280" className="h-[340px] opacity-60" fill="none">
      ...
      {/* Neck */}
      <g id="neck" style={{ transformOrigin: "60px 43px", transform: `scaleX(${s.neck * s.overall})`, cssText: T }}>
        <rect x="54" y="38" width="12" height="10" rx="4"
          stroke="hsl(var(--primary))" strokeWidth="0.8" fill="none" />
      </g>

      {/* Torso */}
      <g id="torso" style={{ transformOrigin: "60px 94px", transform: `scaleX(${s.torso * s.overall})`, cssText: T }}>
        <path
      ...
      {/* Waist guide */}
      <g id="waist" style={{ transformOrigin: "60px 115px", transform: `scaleX(${s.waist * s.overall})`, cssText: T }}>
      ...
      {/* Hips guide */}
      <g id="hips" style={{ transformOrigin: "60px 138px", transform: `scaleX(${s.hips * s.overall})`, cssText: T }}>
      ...
      {/* Left arm */}
      <g id="left-arm" style={{ transformOrigin: "24px 93px", transform: `scaleX(${s.arm})`, cssText: T }}>
        <path
      ...
      {/* Right arm */}
      <g id="right-arm" style={{ transformOrigin: "96px 93px", transform: `scaleX(${s.arm})`, cssText: T }}>
        <path
      ...
      {/* Left leg */}
      <g id="left-leg" style={{ transformOrigin: "40px 200px", transform: `scaleX(${s.leg})`, cssText: T }}>
        <path
      ...
      {/* Right leg */}
      <g id="right-leg" style={{ transformOrigin: "80px 200px", transform: `scaleX(${s.leg})`, cssText: T }}>
        <path
