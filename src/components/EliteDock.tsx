...
const EliteDock = () => {
  ...
  return (
    <>
      <motion.div initial={{ y: 100, opacity: 0, x: "-50%" }} animate={{ y: 0, opacity: 1, x: "-50%" }} transition={{ type: "spring", bounce: 0, duration: 0.4 }} className="fixed bottom-4 left-1/2 z-[40] flex items-center gap-4 w-max pointer-events-none" style={{ paddingBottom: "env(safe-area-inset-bottom)" }}>
