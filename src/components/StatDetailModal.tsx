...
const statConfigs: Record<StatType, StatConfig> = {
  sleep: {
    ...
    history30: generate30DayData([7.2, 6.8, 8.1, 7.5, 6.5, 8.5, 7.5], 1.5),
    average7: 7.4,
    average30: 7.2,
    trend: "up",
    trendPercent: 8,
  ...
  calories: {
    ...
    history30: generate30DayData([2150, 1980, 2300, 2100, 1850, 2450, 2000], 400),
    average7: 2011,
    average30: 2085,
    trend: "stable",
    trendPercent: 2,
  ...
  water: {
    ...
    history30: generate30DayData([2.5, 2.0, 1.8, 2.2, 2.8, 3.0, 2.3], 0.8),
    average7: 2.3,
    average30: 2.4,
    trend: "down",
    trendPercent: 5,
                  ...
                  return (
                    <div key={`${point.day}-${index}`} className="flex-1 flex flex-col items-center gap-2">
                      ...
                      <span className={`text-[10px] font-medium ${isLast ? config.color : "text-muted-foreground"}`}>
                        {statType === "calories" ? Math.round(point.value) : point.value}
                      </span>
            ...
            <div className="px-5 pb-8 grid grid-cols-2 gap-3">
              <div className="backdrop-blur-xl bg-white/[0.02] border border-white/[0.05] rounded-xl p-3 text-center">
                ...
                <p className="text-foreground text-lg font-bold">
                  {statType === "calories" ? Math.round(average) : average}
