...
export const shopSupplements: ShopSupplement[] = [
  {
    ...
    inStock: true, servings: 60, perServing: "5g", tags: ["En Çok Satan", "Koç Önerisi"],
  },
  {
    ...
    inStock: true, servings: 30, perServing: "30g (1 scoop)", tags: ["En Çok Satan"],
  },
  {
    ...
    inStock: true, servings: 60, perServing: "2 kapsül", tags: ["Koç Önerisi"],
  },
  {
    ...
    inStock: true, servings: 90, perServing: "1 kapsül", tags: [],
  },
  {
    ...
    inStock: true, servings: 60, perServing: "2 kapsül", tags: [],
  },
  {
    ...
    inStock: false, servings: 30, perServing: "1 scoop", tags: ["Yeni"],
  },
];
